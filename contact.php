...
<body>
    ...
    <div id="contact" class="contact section s4">
        <div class="container">
            <h4 style="margin-top: 100px">যোগাযোগ</h4>
            <p class="contact-head">আমাদের অর্থনীতিতে কৃষির অবদান অনস্বীকার্য। কৃষকদের প্রায় প্রতিদিনই বীজ, ফসল ও জমি সংক্রান্ত কোনো না কোনো সমস্যায় পড়তে হয়। কৃষকদেরকে যথাসময়ে সঠিক তথ্য সরবরাহ করাই “বাংলার কৃষক” এর উদ্দেশ্যেই। তাইআপনাদের যেকোন সমস্যায় আপনারা মাদের সাথে যোগাযোগ ক্রতে পারবেন </p>
            <div class="row contact-form">
                <form>
                    ...
                    <div class="col-md-6 textarea">
                        <textarea placeholder="মেসেজ"></textarea>
                    </div>
                    <div class="clearfix"> </div>
                    <br />
                    <input class="btn-red-lg" type="submit" value="মেসেজ সেন্ড করুন " />
                </form>
            </div>
        </div>
    </div>
