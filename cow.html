...
<body>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top: 60px; overflow:hidden;">
        <div class="thumbnail" style="margin-top:60px; margin-bottom:100px;">
            <img src="images/cow/cow_banner2.png" alt="" />
        </div>
    </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <td>১</td>
                            <td>হলিস্টিন-ফ্রিজিয়ান</td>
                            <td>৪৫০০-৯০০০ লিটার</td>
                            <td>৬৭৫ কেজি</td>
                            <td><a href="cow_frizian.php">বিস্তারিত</a></td>
                        </tr>
                        <td>২</td>
                        <td>শাহীওয়াল</td>
                        <td>৩০০০-৪০০০ লিটার</td>
                        <td> ৪৫০-৫৫০ কেজি</td>
